...
<body>
	...
	<%
		...
		List<Restoran> restoran = rDAO.PretragaRestorana(nazivRest, vrstaRest);
		Korisnik k1 = kDAO.KorisnikEmail(email);
		int id1 = k1.getIdKor();
	%>
	<ul class=prvo>
...
<div class="cetvrto">
	...
	<table class=tabela2>
		<tr>
				...
				<tr><td>
					<form action="restoranSortiranoPoNazivuASC.jsp?email=<%=email %>">
					  <input type="hidden" name="email" value="<%=email%>">
					  <input type="hidden" name="nazivRest" value="<%=nazivRest%>">
					  <input type="hidden" name="vrstaRest" value="<%=vrstaRest%>">
					  
						<input class="dugme" type="submit" value="Sortiraj" >
					</form>
				</td>
		...
		<tr>
				...
				<input type="hidden" name="idKarte" value="<%=r.getKartaPica() %>">
				<input type="hidden" name="idRestoran" value="<%=r.getIdRestorana() %>">
				<input class="dugme" type="submit" value="Rezervisi"></td>
				</form>
			<%
				}
			%>

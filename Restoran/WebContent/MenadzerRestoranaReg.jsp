...
<title>Registrovanje menadzera restorana</title>
<meta charset='utf-8'>
...
<div class="template">
<div class="fild">
<form action="MenadzerRestoranaReg">
<input type="text" name="imeMenRes" placeholder="Ime" title="Polje za ime ne moze biti prazno. Ime moze da sadrzi samo slova." required pattern="[a-zA-Z]+" class="centar" required autofocus>
<br>
<br>
<br>
<input type="text" name="prezimeMenRes" placeholder="Prezime" title="Polje za prezime ne moze biti prazno i moze da sadrzi samo slova." required pattern="[a-zA-Z]+"class="centar" required>
<br>
<br>
<br>
<input type="text" name="jmbg" placeholder="JMBG" class="centar" required>
<br>
<br>
<br>
...
%>
	<select name="idRestoran" class="selekt">

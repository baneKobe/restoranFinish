...
<title>Menadzer Sistema update</title>
<meta charset='utf-8'>
...
MenadzerSistema menadzer = null;
if(email != null){
	MenadzerSistema menadzer1 = menDao.GetMenadzerSistemaByEmail(email);
	menadzer = menadzer1;
}
String ime= menadzer.getImeMenSis();
String prezime= menadzer.getPrezimeMenSis();
String jmbg= menadzer.getJmbgMenSis();
String mejl= menadzer.getEmailMenSis();
String password= menadzer.getPasswordMenSis();
int idMenSis = menadzer.getIdMenSis();

%>
<table class="tabela">
				<form action="UpdateMenadzerSistema">
					<tr class="red">
					...
					<tr class="red">
						<td class="polje">JMBG:</td> <td class="polje">  <input type="text" name="jmbg" value="<%=jmbg%>" class="unos" required></td>
					</tr>
					<tr class="red">
					...
					<input type="hidden" name="idMenSis" value="<%=idMenSis%>">

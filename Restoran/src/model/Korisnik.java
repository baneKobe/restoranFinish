...
public class Korisnik {
	...
	public Korisnik(String username, String prezime, String email, int idKor, int ja) {
		super();
		this.username = username;
		this.prezime = prezime;
		this.email = email;
	...
	public String toString() {
		return "Korisnik [username=" + username + ", lozinka=" + lozinka + ", prezime=" + prezime + ", email=" + email
				+ ", idKor=" + idKor + ", ja=" + ja + "]";
	}
	...
	public Korisnik(String username, String prezime, String email) {
		super();
		this.username = username;
		this.prezime = prezime;
		this.email = email;

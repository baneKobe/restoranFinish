...
public class Pice {
	...
	protected int dejanidKart;

	public int getDejanidKart() {
		return dejanidKart;
	}
	...
	public Pice(String naziv, String opis, double cijena, int dejanidKart) {
		super();
		this.naziv = naziv;
		this.opis = opis;
		this.cijena = cijena;
		this.dejanidKart = dejanidKart;
	}




	public void setDejanidKart(int dejanidKart) {
		this.dejanidKart = dejanidKart;
	}
